class Product{
  final String name, type, description, shopName;
  final double price, deliveryTermInDays;
  final List images;

  Product({
    required this.name, required this.type,
    required this.shopName, required this.price,
    required this.deliveryTermInDays, required this.images,
...
List<Product> demoProduct = [
  Product(
    name: "تطريز",
    type: '',
    shopName: 'متجر الشيماء',
    price: 20,
    images: ['assets/images/register.svg'],
